...
public class Parser {
	...
	private void declaration(Declarations ds) {
		...
		while (token.type().equals(TokenType.Identifier)) {
			...
			// Oyutnuudiin nuhuh heseg("Type Identifier { , Identifier } ;" gesen butetstei
			// zarlaltuudiig shalgah.)
		}
		if (!ident)
			error("Identifier");
	...
	private Assignment assignment() {
		...
		return new Assignment(v, e); // Oyutnuudiin hiih heseg ("Identifier = Expression;" gesen butetstei bh utga
										// olgoh uildliig shalgaj butsaah)
	}
	...
	private Value literal() {
		...
		case FloatLiteral:
			...
			break;
		// ...Oyutnuudiin hiih heseg (busad turliin utguudiig)
		}
		return v;
	}
	...
	public static void main(String args[]) {
		...
		Parser parser = new Parser(new Lexer("C:\\Users\\gdwoo\\eclipse-workspace\\f.cs305\\src\\lab4\\convert.cpp"));
