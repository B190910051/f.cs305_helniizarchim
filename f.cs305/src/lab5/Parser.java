...
public class Parser {
    ...
    private Loop whileStatement () {
        ...
        match(TokenType.RightParen);
        Statement s = this.statement();
        return new Loop(t, s); //LAB3 Oyutnuudiin hiih heseg (umnuh nuhtsult dawtaltiig deerh zui togtoltoigoor shalgah functs.)  
    }
    ...
    private Expression equality () {
        ...
        return e; //LAB3 Oyutnuudiin hiih heseg (edgeer uildliin daraallaaraa doosh daraalan bichigdsen functsuud ni 
    ...
    public static void main(String args[]) {
        ...
        Parser parser  = new Parser(new Lexer("C:\\Users\\gdwoo\\git\\f.cs305_helniizarchim\\f.cs305\\src\\lab5\\newton.cpp"));
