...
class Program {
	...
	private String BlockText(Statement s, String tab) {
		if (s instanceof Skip)
			return BlockText((Skip) s, tab + "  ");
		if (s instanceof Assignment)
			return BlockText((Assignment) s, tab + "  ");
		if (s instanceof Conditional)
			return BlockText((Conditional) s, tab + "  ");
		if (s instanceof Loop)
			return BlockText((Loop) s, tab + "  ");
		if (s instanceof For)
			return BlockText((For) s, tab + "  ");
		if (s instanceof Block)
			return BlockText((Block) s, tab + "  ");
	...
	private String BlockText(Expression e, String tab) {
		if (e instanceof Value) {
			...
			if (v instanceof IntValue)
				return tab + "IntValue: " + v.intValue();
			if (v instanceof BoolValue)
				return tab + "BoolValue: " + v.boolValue();
			if (v instanceof CharValue)
				return tab + "CharValue: " + v.charValue();
			if (v instanceof FloatValue)
				return tab + "FloatValue: " + v.floatValue();
		}
