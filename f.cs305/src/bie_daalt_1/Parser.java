...
public class Parser {
    ...
    private Statement statement() {
        // Statement --> ; | Block | Assignment | IfStatement | WhileStatement | ForStatement
        ...
        switch(token.type())
        {
        	...
        	case For: s = this.forStatement(); break;
        	// student exercise
    ...
    public static void main(String args[]) {
        ...
        Parser parser  = new Parser(new Lexer("C:\\Users\\gdwoo\\eclipse-workspace\\f.cs305\\src\\bie_daalt_1\\newton.cpp"));
